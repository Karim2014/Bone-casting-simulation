...
Это приложение Лабораторная работа 1 создано автоматически с помощью мастера 
приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения Лабораторная работа 1.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем Лабораторная работа 1.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
